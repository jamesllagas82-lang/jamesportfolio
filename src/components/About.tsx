    ...
    <section id="about" className="max-w-5xl mx-auto py-20 px-6">
      ...
      <div className="space-y-4 text-gray-700 leading-relaxed">
        ...
        <p>
          ...
          I believe that technology should not only solve problems but also
          deliver meaningful experiences that make people's lives easier and
          more productive.
        </p>
        ...
        <p>
          ...
          businesses. Whether it's a website, mobile application, or full-stack
          system, I am always excited to take on new challenges and continue
          improving my craft.
        </p>
      </div>
    </section>
